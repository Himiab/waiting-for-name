...
function Layout({ children, isHighRisk = false }) {
  const time = useClock();
  const [uptime, setUptime] = reactExports.useState(0);
  reactExports.useEffect(() => {
    const start = Date.now();
    const id = setInterval(
      () => setUptime(Math.floor((Date.now() - start) / 1e3)),
      1e3
    );
    return () => clearInterval(id);
  }, []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `min-h-screen font-mono flex flex-col relative overflow-hidden ${isHighRisk ? "bg-[oklch(0.04_0.04_29)]" : "bg-background"}`,
      ...
      children: [
        ...
        isHighRisk && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              ...
              boxShadow: "inset 0 0 40px oklch(0.54 0.28 29 / 0.3), 0 0 40px oklch(0.54 0.28 29 / 0.3)"
            },
            "aria-hidden": "true"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "header",
          {
            className: `relative z-10 border-b px-6 py-3 flex items-center justify-between ${isHighRisk ? "border-destructive bg-[oklch(0.06_0.04_29)]" : "border-primary bg-card"}`,
            style: isHighRisk ? { boxShadow: "0 2px 20px oklch(0.54 0.28 29 / 0.4)" } : { boxShadow: "0 2px 20px oklch(0.75 0.32 142 / 0.15)" },
            children: [
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "polygon",
                        {
                          ...
                          stroke: isHighRisk ? "oklch(0.54 0.28 29)" : "oklch(0.75 0.32 142)",
                          strokeWidth: "1.5",
                          fill: "none",
                          style: {
                            filter: isHighRisk ? "drop-shadow(0 0 4px oklch(0.54 0.28 29))" : "drop-shadow(0 0 4px oklch(0.75 0.32 142))"
                          }
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "polygon",
                        {
                          ...
                          fill: isHighRisk ? "oklch(0.54 0.28 29 / 0.15)" : "oklch(0.75 0.32 142 / 0.1)",
                          stroke: isHighRisk ? "oklch(0.54 0.28 29 / 0.6)" : "oklch(0.75 0.32 142 / 0.6)",
                          strokeWidth: "0.5"
                        }
                      )
                    ]
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: "VANGUARD CYBER"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground tracking-widest uppercase", children: isHighRisk ? "// THREAT ACTIVE — SYSTEM ALERT //" : "// THREAT DETECTION SYSTEM v2.1 //" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6 text-xs text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  "UP_TIME:",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: isHighRisk ? "glow-red" : "glow-green", children: formatUptime(uptime) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  "LATENCY: ",
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "glow-cyan", children: [
                    latency,
                    "ms"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  "TIME: ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: timeStr })
                ] }),
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            style: {
                              background: isHighRisk ? "oklch(0.54 0.28 29)" : "oklch(0.75 0.32 142)",
                              boxShadow: isHighRisk ? "0 0 6px oklch(0.54 0.28 29)" : "0 0 6px oklch(0.75 0.32 142)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "relative z-10 flex-1 overflow-auto", children }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative z-10 border-t border-border bg-card px-6 py-2 flex items-center justify-between text-[10px] text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "© ",
...
const VOCAB_SIZE = (/* @__PURE__ */ new Set([
...
function tokenize(input) {
  return input.toLowerCase().split(/[\s.,;:!?@/\\()\[\]{}<>"'|=+\-_&#%^*~`]+/).filter((t) => t.length > 2);
}
function naiveBayesScore(tokens) {
  let logSpam = Math.log(0.5);
  let logHam = Math.log(0.5);
  for (const token of tokens) {
    const spamCount = SPAM_VOCAB[token] ?? 0;
    const hamCount = HAM_VOCAB[token] ?? 0;
    const pSpam = (spamCount + ALPHA) / (TOTAL_SPAM_TOKENS + ALPHA * VOCAB_SIZE);
...
function scanInput(input) {
  ...
  const triggeredRules = HEURISTIC_RULES.filter(
    (rule) => rule.regex.test(input)
  ...
  const combined = Math.min(1, bayesProb * 0.6 + heuristicBoost * 0.4);
  ...
  if (isHighRisk) {
    ...
    const ruleIds = triggeredRules.map((r) => `RULE-${r.id.toString().padStart(3, "0")}`).join(", ");
...
function PanelHeader({
  ...
  const cls = color === "cyan" ? "glow-cyan" : color === "red" ? "glow-red" : "glow-green";
...
function ThreatMeter({ probability }) {
  const pct = Math.round(probability * 100);
  const isHigh = probability >= 0.7;
  const isMed = probability >= 0.35;
  const color = isHigh ? "oklch(0.54 0.28 29)" : isMed ? "oklch(0.80 0.22 60)" : "oklch(0.75 0.32 142)";
  const label = isHigh ? "CRITICAL" : isMed ? "ELEVATED" : "NOMINAL";
  const segments = 30;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground tracking-widest uppercase mb-1", children: "REAL-TIME PROBABILITY SCORING METER" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-px", "aria-label": `Threat probability: ${pct}%`, children: Array.from({ length: segments }, (_, i) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        `meter-segment-${String(i).padStart(2, "0")}`
      );
    }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: `PROBABILITY OF THREAT: ${pct}% (${label})${isHigh ? " — SIGNATURE MATCH: PHISHING/MALWARE DETECTED" : ""}`
      }
    )
  ] });
}
function TokenDisplay({ tokens }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground tracking-widest uppercase", children: "TOKENIZATION OUTPUT" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1 min-h-[32px]", children: tokens.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground italic", children: "// awaiting input..." }) : tokens.map((tok, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
      ...
      `token-${String(i).padStart(3, "0")}-${tok}`
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-muted-foreground", children: [
      "TOKEN_COUNT: ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "glow-cyan", children: tokens.length })
    ] })
  ] });
}
const SEED_LOGS = [
...
function Dashboard({
  ...
  const [scanLogs, setScanLogs] = reactExports.useState(SEED_LOGS);
  const [isScanning, setIsScanning] = reactExports.useState(false);
  const logRef = reactExports.useRef(null);
  const addLog = reactExports.useCallback((msg, type) => {
  ...
  const handleScan = reactExports.useCallback(() => {
  ...
  const blockingEntries = (result == null ? void 0 : result.isHighRisk) ? [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PanelHeader, { label: "THREAT SCANNING" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground tracking-widest uppercase mb-1", children: "PASTE YOUR SUSPICIOUS URL OR TEXT BELOW:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  onMouseEnter: (e) => {
                    e.currentTarget.style.background = "oklch(0.75 0.32 142 / 0.25)";
                  },
                  onMouseLeave: (e) => {
                    e.currentTarget.style.background = "oklch(0.75 0.32 142 / 0.1)";
                  },
                  children: isScanning ? "// SCANNING..." : "[ SCAN INPUT ]"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground", children: isScanning ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "glow-cyan animate-pulse", children: "// SCANNING FOR THREATS..." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "// CTRL+ENTER to scan — ",
              result ? `Last scan: ${(/* @__PURE__ */ new Date()).toLocaleTimeString()}` : "Awaiting input"
            ] }) })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PanelHeader, { label: "PROBABILITY ANALYSIS", color: "cyan" }),
            result ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ThreatMeter, { probability: result.probability }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TokenDisplay, { tokens: result.tokens })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-32 text-muted-foreground text-xs space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl opacity-20", children: "◈" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tracking-widest uppercase", children: "// awaiting scan input..." })
            ] })
          ]
        }
      )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PanelHeader, { label: "MODEL DIAGNOSTICS", color: "cyan" }),
            result ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground uppercase tracking-widest", children: "CURRENT ML MODEL ACCURACY AND PERFORMANCE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "NAIVE_BAYES_PROB:" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: result.probability >= 0.65 ? "glow-red" : result.probability >= 0.35 ? "" : "glow-green",
                      style: result.probability >= 0.35 && result.probability < 0.65 ? {
                        color: "oklch(0.80 0.22 60)",
                        textShadow: "0 0 8px oklch(0.80 0.22 60 / 0.6)"
                      } : {},
                      children: `${(result.probability * 100).toFixed(2)}%`
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "TOKEN_COUNT:" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "glow-cyan", children: result.tokens.length })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "RULES_FIRED:" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: result.triggeredRules.length > 0 ? "glow-red" : "glow-green",
                      children: result.triggeredRules.length
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      children: result.isHighRisk ? "THREAT" : "NOMINAL"
                    }
                  )
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-2 mt-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] text-muted-foreground mb-1 tracking-widest", children: "TOKEN STREAM:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: result.tokens.length > 0 ? result.tokens.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "[" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "glow-cyan", children: t }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "]" }),
                          " "
                        ]
                      },
                      `diag-token-${String(i).padStart(3, "0")}-${t}`
                    )) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground italic", children: "// no tokens" })
                  }
                )
              ] })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground italic space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "// MODEL READY" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "// VGUARD_ML_2.1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glow-green", children: "ACCURACY: 99.1%" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "FALSE_POSITIVE: 0.02%" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PanelHeader, { label: "HEURISTIC AUDIT", color: "green" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ref: logRef,
                ...
                children: [
                  scanLogs.map((log2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: "flex gap-2",
                      style: { color: logColor(log2.type) },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0 text-muted-foreground", children: log2.ts }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "break-all leading-relaxed", children: log2.message })
                      ]
                    },
                    `${log2.ts}-${log2.message}`
                  )),
                  (result == null ? void 0 : result.triggeredRules.length) === 0 && result !== null && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "oklch(0.60 0 0)" }, children: "// No heuristic rules triggered" })
                ]
              }
            )
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(PanelHeader, { label: "MODEL PARAMETERS", color: "cyan" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground tracking-widest uppercase mb-2", children: "CONFIGURATIONS FOR CURRENT SECURITY MODEL" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 border-t border-border pt-2", children: [
                {
                  label: "MODEL_VERSION",
                ...
                {
                  label: "SPAM_TOKENS",
                  value: (result == null ? void 0 : result.modelParams.spamTokens.toString()) ?? "151",
                  color: "cyan"
                },
                {
                  label: "HAM_TOKENS",
                  value: (result == null ? void 0 : result.modelParams.hamTokens.toString()) ?? "140",
                  color: "cyan"
                },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            borderColor: (result == null ? void 0 : result.isHighRisk) ? "oklch(0.54 0.28 29)" : "oklch(0.14 0 0)",
            background: (result == null ? void 0 : result.isHighRisk) ? "oklch(0.06 0.04 29)" : "oklch(0.08 0 0)",
            boxShadow: (result == null ? void 0 : result.isHighRisk) ? "inset 0 0 30px oklch(0.54 0.28 29 / 0.15), 0 0 20px oklch(0.54 0.28 29 / 0.2)" : "none",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              PanelHeader,
              {
                ...
                color: (result == null ? void 0 : result.isHighRisk) ? "red" : "green"
              }
            ),
            (result == null ? void 0 : result.isHighRisk) ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: "⚠ BLOCKING ACTIVE ⚠"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1 text-[9px]", children: blockingEntries.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    color: entry.color,
                  ...
                  children: `[BLOCKED] ${entry.msg}`
                },
                entry.msg
              )) }),
              result.systemLogEntry && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: result.systemLogEntry
                }
              )
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 text-[9px] text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glow-green", children: "// No active blocks" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "// Monitoring all traffic" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "// Heuristics armed" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "// ML classifier ready" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "// Awaiting scan input..." })
              ] })
            ] })
          ]
        }
...
function App() {
  const [isHighRisk, setIsHighRisk] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { isHighRisk, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dashboard, { onRiskChange: setIsHighRisk }) });
}
